...
estoque_app = Blueprint('agenda_app', __name__, template_folder='templates')

@estoque_app.route('/evento', methods=['GET'])
def listar():
    user = service_buscarUser(1)
    estoque = service_listarEstoque()
    print(estoque)
